...
const RecipesInfo = ({recipesInfo}) => {
    ...
    const {rating,recipe_name,ingredients,cooking_method
    }=recipesInfo;
    ...
    return (
        ...
        <div className="card-body">
            ...
            <div className="card-actions justify-end">
                ...
                <button className="btn btn-primary" onClick={setHeart} disabled={btnDisable}> Favorite <ToastContainer/>  </button>
