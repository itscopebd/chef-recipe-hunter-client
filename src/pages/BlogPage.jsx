...
const BlogPage = () => {
    ...
    return (
        <div className='container py-20 md:px-0 px-10 mx-auto'>
            <p className='text-center'><Pdf targetRef={ref} filename="programming hero is the boss.pdf">
                {({ toPdf }) => <button className='btn bg-orange-500 hover:bg-purple-500 border-0' onClick={toPdf}>Download</button>}
            </Pdf></p>
            <div ref={ref}>
